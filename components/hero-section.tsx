      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="font-heading text-5xl md:text-7xl font-bold mb-6 text-balance">
            Bem-Vindo ao <span className="text-primary">Meu Portfólio</span>
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-balance">
            Nesse Site, eu mostro um pouco sobre meus projetos e o meu perfil profissional.
          </p>
          <motion.div
          ...
          >
            <Button
              size="lg"
              className="group text-lg px-8 py-6 bg-primary hover:bg-primary/90 transition-all duration-300"
              asChild
            >
              <a
